        ...
        <div class="block-content">
                ...
                <form method="POST" action="" name="frmForm" enctype="multipart/form-data">
                    <div class="dataTable_filter">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <input name="tukhoa" type="text" class="form-control" id="tukhoa" placeholder="Tìm kiếm..." style="display: inline-block; width: auto; margin-right: 5px;" />
            ...
            <?php            
                ...
                if ($_REQUEST['cat']!='') :
                    ...
                    $where = "parent in ($list_parent) and (id='{$tukhoa}' or name LIKE '%$tukhoa%' or '{$tukhoa}'=-1) and cate=1 and (idshop='{$idshop}') and lang='{$lang}'";
                endif;
                    ...
                    <table class="table table-bordered table-hover btl-list-bbli bg-white">
                        <thead>
                            <tr>
                                ...
                                <td class="text-left">
                                    <a href="<?=url_direct('get',$_GET['act'])?>&cat=<?=$_REQUEST['cat']?>&pageNum=<?=$_REQUEST['page']?>&sortby=name&direction=<?=$_REQUEST['direction']==1?0:1?>">Tên sản phẩm</a>
                                </td>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-left">
                                    <span class="label label-success"><?php echo $parent['name']!=''?$parent['name']:get_field('tbl_language','id',$lang,'name')?></span>
                                </td>
                                <td class="text-center">
                                    <div class="star tool <?php echo $row['hot']==1?'active':'' ?>" data-action='toggleStatus' data-field='hot' data-table='tbl_item' title="Nổi bật" value="<?php echo $row['id']?>"></div>
                                </td>
                                <td class="text-center">
                                    <div class="check tool <?php echo $row['status']==1?'active':'' ?>" data-action='toggleStatus' data-field='status' data-table='tbl_item' title="Ẩn hiện" value="<?php echo $row['id']?>"></div>
                                </td>
                                <td class="text-right">
                                    <a href="<?=url_direct('edit',$_GET['act'],'_m','&cate='.$_REQUEST['cat'].'&page='.$_REQUEST['pageNum'].'&id='.$row['id'])?>" title="Sửa" class="btn btn-xs btn-pencil btn-primary">
