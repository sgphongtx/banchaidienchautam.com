...
<?php        
    switch ($_GET['action']){
        case 'del' :
            $id = $_GET['id'];
            $r = getRecord("tbl_map","id=".$id);
            if($r['idshop']==$idshop){
                @$result = mysqli_query($conn,"delete from tbl_map where id='".$id."'");
                if ($result){
...
<div class="content bg-gray-lighter">
    <div class="row items-push">
        <div class="col-sm-7">
            <h1 class="page-heading">Bản đồ <small>Danh sách Bản đồ</small></h1>
        </div>
    ...
    <div class="block">
        ...
        <div class="block-content">
            ...
            <?php                
                ...
                $totalRows=countRecord("tbl_map",$where);
            ?>
                    ...
                    <table class="table table-bordered table-hover btl-list-bbli bg-white">
                        <thead>
                            <tr>
                                ...
                                <td style="width: 150px;" class="text-center">Hình ảnh</td>
                                <td class="text-left">
                        ...
                        <tbody>
                            <?php
                               $sortby="order by date_added";
                                ...
                                $sql="select * from tbl_map where $where $sortby $direction limit ".($startRow).",".$pageSize;
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="check tool <?php echo $row['status']==1?'active':'' ?>" data-action='toggleStatus' data-field='status' data-table='tbl_map' title="Ẩn hiện" value="<?=$row['id']?>"></div>
                                </td>
                                <td class="text-right">
