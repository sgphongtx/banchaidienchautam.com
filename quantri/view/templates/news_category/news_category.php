...
<div class="content bg-gray-lighter">
    <div class="row items-push">
        <div class="col-sm-7">
            <h1 class="page-heading">Tin tức <small>Danh mục tin tức</small></h1>
        </div>
                    ...
                    <table class="table table-bordered table-hover btl-list-bbli bg-white">
                        <thead>
                            <tr>
                                ...
                                <td style="width: 80px;" class="text-center">Vị trí</td>
                                <td style="width: 80px;" class="text-center">Nổi bật</td>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="star tool <?php echo $row['pos']==1?'active':'' ?>" data-action='toggleStatus' data-field='pos' data-table='tbl_item_category' title="Vị trí" value="<?php echo $row['id']?>"></div>
                                    </td>
                                    <td class="text-center">
