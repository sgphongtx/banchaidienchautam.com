...
if (isset($_POST['btnSave'])){
	...
	if ($errMsg=='') {
		...
		if (!empty($_POST['id'])){	
            ...
            $image_ = $image;
			$sql = "INSERT INTO tbl_item_category (idshop, name, cate, parent, subject, subject_temp, detail_short, image, link, sort, title, description, keyword, status, lang, date_added, last_modified) VALUES ('$idshop', '$name', '2', '$parent', '$subject', '$subject_temp', '$detail_short', '$image_', '$link', '$sort', '$title', '$description', '$keyword', '1', '$lang', now(), now())"; }
...
<div class="content bg-gray-lighter">
    <div class="row items-push">
        <div class="col-sm-7">
            <h1 class="page-heading">Tin tức <small>Thêm mới danh mục Tin tức</small></h1>
        </div>
        <div class="col-sm-5 text-right hidden-xs">
            <ol class="breadcrumb push-10-t">
                <li><a href="<?=url_direct()?>">Quản trị</a></li>
                <li><a href="<?=url_direct('get')?>">Danh mục</a></li>
                <li>Thêm mới</li>
            </ol>
        </div>
    </div>
	                           ...
	                           <script language="javascript">
	                              ...
	                              <?php foreach($data_menu as $item) { ?>
	                                 menus.push({
	                                    ...
	                                    menu_name: "<?php echo stripslashes($item['name']); ?>",
