    ...
    switch ($_GET['action']){
        case 'del' :
            ...
            if($r['idshop']==$idshop){
                ...
                if ($result) $errMsg1 = "Đã xóa thành công.";
...
<div class="content bg-gray-lighter">
    <div class="row items-push">
        <div class="col-sm-7">
            <h1 class="page-heading">Liên hệ <small>Thông tin liên hệ</small></h1>
        </div>
    ...
    <div class="block">
        ...
        <div class="block-content">
            ...
            <?php
                ...
                $where="1=1 and (id='{$tukhoa}' or name LIKE '%$tukhoa%' or '{$tukhoa}'=-1) and cate=5 and (idshop='{$idshop}') and lang='{$lang}'";
