...
<div class="content bg-gray-lighter">
    <div class="row items-push">
        <div class="col-sm-7">
            <h1 class="page-heading">Đối tác <small>Danh sách đối tác</small></h1>
        </div>
                    ...
                    <table class="table table-bordered table-hover btl-list-bbli bg-white">
                        <thead>
                            <tr>
                                ...
                                <td class="text-left">
                                    <a href="<?=url_direct('get',$_GET['act'])?>&pageNum=<?=$_REQUEST['page']?>&sortby=name&direction=<?=$_REQUEST['direction']==1?0:1?>">Tên đối tác</a>
                                </td>
                        ...
                        <tbody>
                            <?php
                                ...
                                $sql="select * from tbl_slider where $where $sortby $direction limit ".($startRow).",".$pageSize;
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="check tool <?php echo $row['status']==1?'active':'' ?>" data-action='toggleStatus' data-field='status' title="Ẩn hiện" value="<?=$row['id']?>"></div>
                                </td>
                                <td class="text-right">
