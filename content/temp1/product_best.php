<div class="widget widget-static-block">
   <div class="featured-wrap space-base">
      <div class="block-title">
         <h3><?php echo module_keyword($mang11,$mang22,"product_best");?></h3>
      </div>
         ...
         <div class="products-grid">
            <ul class="row product-items same-height clearfix">
               <?php
                  ...
                  if($sl == "") $sl=9;
                  $i=1;
                  $result = get_records("tbl_item","cate=1 and status=1 and hot=1","id desc","0,".$sl,$lang);
