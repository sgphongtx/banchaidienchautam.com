...
if (isset($_REQUEST['order'])) {
   ...
   if($err==FALSE) {
      ...
      $vale1 = 'idshop, price, idKH ,soDT, ThoiDiemDatHang, TenNguoiNhan, DiaChi, yahoo, thanhtoan, GhiChu, status';
      $vale2 = "'$idshop', '$total', '$idKH', '$phone', '$ngay', '$name', '$address', '$email', '', '$note', '1'";
      $hinh  = "";
